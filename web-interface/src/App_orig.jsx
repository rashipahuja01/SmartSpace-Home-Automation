    ...
    <div className="min-h-screen bg-gray-800 py-6 flex flex-col justify-center sm:py-10">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center mt-8">
          <h2 className="text-sm  text-gray-400">
            Vardan Tuteja  || Rashi Pahuja || Sidhi Ojha
          </h2>
          <h2 className="text-sm  text-gray-400">
             21BRS1591  || 21BEC1534 || 21BCE1994
          </h2>
          <h2 className="text-sm  text-gray-400">
             Project Guide : Dr. Chanthini Baskar
             (Associate Professor, SENSE)
          </h2>
          <h2 className="text-sm  text-gray-500">PROJECT-1 (BCSE497J)</h2>
        </div>
      </div>
    </div>
  );
